...
<head>
    ...
    <style>
        ...
        .card { background: #ffffff; padding: 40px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); width: 100%; max-width: 400px; }
...
<body>
    <div class="card">
        ...
        <p style="font-size: 13px; color: #666; text-align: center;">Nhập email đã đăng ký, FASHION HAVEN sẽ gửi link đặt lại mật khẩu cho bạn.</p>
